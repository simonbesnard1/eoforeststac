...
JRC_TMF_CFG = {
    ...
    # ------------------------------------------------------------------
    "id": "JRC_TMF",
    "title": "JRC Tropical Moist Forests (TMF) - Forest change (degradation, deforestation, regrowth) (30 m)",
    "description": (
    ...
    # HREF layout
    # ------------------------------------------------------------------
    "collection_href": f"{S3_HTTP_BASE}/JRC_TMF/collection.json",
    "base_path": f"{S3_HTTP_BASE}/JRC_TMF",
    # ------------------------------------------------------------------
    # Governance
    # ------------------------------------------------------------------
    "license": "various",
